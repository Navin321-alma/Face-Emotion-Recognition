...
def main():
    ...
    if choice == "Home":
        ...
        html_temp4 = """
                             		...
                             		<h4 style="color:white;text-align:center;">This Application is developed by Navin kodam using Streamlit Framework, Opencv, Tensorflow and Keras library for demonstration purpose. If you're on LinkedIn and want to connect, just click on the link in sidebar and shoot me a request. If you have any suggestion or wnat to comment just write a mail at kodamnavin18@gmail.com. </h4>
